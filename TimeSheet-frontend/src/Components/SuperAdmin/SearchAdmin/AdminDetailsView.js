...
function AdminDetailsView() {
    ...
    async function getAdminDetails() {
        ...
        try {
            ...
            const response = await axios.get(`http://13.233.98.111:4555/admins/${id}`)  //to view admin details backend url
    ...
    async function deleteSaveChanges() {
        try {
            ...
            await axios.delete(`http://13.233.98.111:4555/admins/${removeAdminId}`);  //delete admin backend url
