...
function AdminEdit() {
    ...
    useEffect(() => {
        async function getDataFromApi() {
            try {
                const response = await axios.get(`http://13.233.98.111:4555/admins/${id}`); // backend url fetch the admin
    ...
    useEffect(() => {
        ...
        const fetchDataFromApi = async () => {
            try {
                const response = await axios.get("http://13.233.98.111:4555/admins/getadmins");  //backend url
    ...
    async function editSaveConfirmation() {
        ...
        try {
            ...
            await axios.put(`http://13.233.98.111:4555/admins/${id}`, values);  //update admin backend url
