...
function ModifyAdminTimesheet() {
        ...
        try {
            ...
            await Promise.all(
                editableData.map(async (data) => {
                    let response = await axios.put("http://172.31.224.1:4555/admins/working-hours/update", data);
                })
            );
        } catch (error) {
            console.log("error");
    ...
    async function editTimesheetApproveSave() {
        ...
        try {
            ...
            await axios.put(`http://172.31.224.1:4555/admins/working-hours/${id}/approve-range?startDate=${startDate}&endDate=${endDate}`);
    ...
    async function editTimesheetRejectSave() {
        ...
        try {
            ...
            await axios.put(`http://172.31.224.1:4555/admins/working-hours/${id}/reject-range?startDate=${startDate}&endDate=${endDate}&reason=${rejectReason}`);
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                const response = await axios.get('http://172.31.224.1:4555/admin/projects');
    ...
    async function getEditTimesheet() {
        const response = await axios.get(`http://172.31.224.1:4555/admins/working-hours/${id}/range?startDate=${startDate}&endDate=${endDate}`);
